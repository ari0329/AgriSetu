...
def health():
    ...
    return jsonify({
        ...
        'models_loaded': pdf_generator.models_loaded,
...
def whatsapp_webhook():
    ...
    if is_trigger_message(incoming_msg):
        ...
        # Process in background (Twilio will handle the response separately)
        process_prediction_async(sender)
...
def process_prediction_async(sender: str):
    """
    Process prediction request asynchronously
    This runs after the initial TwiML response is sent
    """
    try:
